...
class Config:
    ...
    APP_SHORT_NAME = os.environ.get("APP_SHORT_NAME", "Bx_Botz")
    APP_URL = os.environ.get("APP_URL", "https://telegram.dog/MufazTG")
    ...
    # please reopen
    # https://github.com/MRK-YT/My-TelegramOrg-Bot/issues/3
    APP_DESCRIPTION = os.environ.get(
        "APP_DESCRIPTION",
        "created using https://telegram.dog/My_TelegramOrg_Bot"
    )
    #
